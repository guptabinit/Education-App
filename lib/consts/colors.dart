...
const redColor = Color(0xffC90000);
const goldenColor = Color(0xffE8B500);

const neonBlueColor = Color(0xff648FFF);
const shadowBlueColor = Color(0xffDEDFFF);
const deepBlueColor = Color(0xff123555);
const lightGrey = Color(0xffF4F4F4);
const darkGrey = Color(0xffDCDCDC);

const buttonRed = Color(0xffDB0000);
const buttonGreen = Color(0xff00C308);
